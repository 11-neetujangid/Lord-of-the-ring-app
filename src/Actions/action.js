...
// export const SET_Movie_LIMIT = 'SET_Movie_LIMIT';
...
// export const SET_PAGE_FOR_CHAR = ' SET_PAGE_FOR_CHAR';
...
// export const setMovieLimit = (payload) => ({ type: SET_Movie_LIMIT, payload: payload });
...
// export const setLimit = (payload) => ({ type: SET_LIMIT, payload: payload });
// export const setPage = (payload) => ({ type: SET_PAGE, payload: payload });
// export const setPageForChar = (payload) => ({ type: SET_PAGE_FOR_CHAR, payload: payload });
